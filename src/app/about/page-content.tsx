...
const aboutCards = [
  ...
  },
  {
    ...
    desc: "Certified by Australia's official MARA registered agents and qualified PIER education agent networks."
  }
];
      ...
      <section className="py-20 bg-white overflow-hidden relative border-t border-slate-100">
        ...
        <div className="container relative z-10 px-4 mx-auto max-w-4xl text-center space-y-6">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed font-medium">
            Our qualified educational counselors and MARA registered agents are available to assess your transcripts.
          </p>
          <div className="pt-4">
            <Link href="/contact">
