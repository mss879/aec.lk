...
const popularCourses = [
  ...
  { name: "Accounting & Finance", desc: "Strategic financial audits, corporate finance, taxation structures, and financial management for high-demand global careers.", icon: <Calculator className="w-6 h-6" /> },
...
export function CourseFinderContent() {
  // Wizard State
